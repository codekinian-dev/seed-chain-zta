 ...
 * Queries batches from BATCH-20000 to BATCH-28999
 */
class QuerySeedBatchWorkload extends WorkloadModuleBase {
    constructor() {
        super();
        this.txIndex = 0;
        this.datasetOffset = 20000; // Offset for 150 TPS round
    }
    ...
    async submitTransaction() {
        ...
        // Query from the same range as createSeedBatch-150.js (BATCH-20000 to BATCH-28999)
        // Use random selection within this specific range
        const rangeSize = 9000; // 150 TPS creates 9000 batches (150 TPS * 60s)
