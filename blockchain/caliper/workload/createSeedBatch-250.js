...
/**
 * Workload module for createSeedBatch transaction - 250 TPS Round
...
class CreateSeedBatchWorkload extends WorkloadModuleBase {
    ...
    async initializeWorkloadModule(workerIndex, totalWorkers, roundIndex, roundArguments, sutAdapter, sutContext) {
        ...
        console.log(`[Worker ${workerIndex}] Initialized for Round ${roundIndex} (250 TPS). Current txIndex: ${this.txIndex}`);
    }
